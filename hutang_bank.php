                        ...
                        <div class="row p-t-50">
                            <div class="col-sm-12">
                                <div class="m-b-20 table-responsive">
                                   ...
                                   <a href="#tambah_hutang" data-toggle="modal"> <button class="btn btn-primary waves-effect waves-light" >Tambah hutang</button></a>
										<br><br><div id="tambah_hutang" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                    <h4 class="modal-title">Tabel Tambah hutang</h4>
                                                </div>
                                               <form name="tambah_hutang" action="engine_AZ.php?p=tambah_hutang" method="post" >
                                    ...
                                    <table id="datatable-responsive"
										...
										<tr>
                                            ...
                                            <td><a href="#edit_hutang<?php echo $data['id_hutang'] ?>" data-toggle="modal">
											...
											<a href="#hapus_hutang<?php echo $data['id_hutang']?>" data-toggle="modal"> 
                                             <button class="btn btn-primary waves-effect waves-effect" id="sa-warning">
											<i class="mdi mdi-delete-forever"></i></button> </a>
                                        
										</tr>
										<div id="edit_hutang<?php echo $data['id_hutang'] ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                        <div class="modal-dialog">
                                            <div class="modal-content" >
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                    <h4 class="modal-title">Tabel Edit hutang</h4>
                                                </div>
                                               <form name="edit_hutang" action="engine_AZ.php?p=edit_hutang" method="post" >
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                             ...
                                                             <input type="hidden" class="form-control" name="id_hutang" value="<?php echo $data['id_hutang'] ?>" placeholder="Nama hutang">
									...
									<div id="hapus_hutang<?php echo $data['id_hutang'] ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                        <div class="modal-dialog">
                                            <div class="modal-content" >
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                               ...
                                               <form name="hapus_hutang" action="engine_AZ.php?p=hapus_hutang" method="post">
                                                <div class="modal-body">
                                                    
                                                             <input type="hidden" class="form-control" name="id_hutang" value="<?php echo $data['id_hutang'] ?>">
